...
set output "total_enhancement_factor_cube.png"
...
splot "total_enhancement.dat" u 3:4:5:(log10($6)) w pm3d notitle, "total_enhancement.dat" u (-$3):(-$4):(-$5):(log10($6)) w pm3d notitle;
set title "Fast Secondary"
splot "total_enhancement.dat" u 3:4:5:(log10($7)) w pm3d notitle, "total_enhancement.dat" u (-$3):(-$4):(-$5):(log10($7)) w pm3d notitle;
set cbrange[-0.6:1.2]
set title "Primary"
splot "total_enhancement.dat" u 3:4:5:(log10($8)) w pm3d notitle, "total_enhancement.dat" u (-$3):(-$4):(-$5):(log10($8)) w pm3d notitle;
unset multiplot
unset output
